...
@section('title', 'Confirmer la suppression - ' . $etudiant->name)
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>
                                Vous êtes sur le point de supprimer définitivement l'étudiant <strong>{{ $etudiant->name }}</strong>.
                                Cette action supprimera également toutes les données associées, y compris :
                            </p>
                            <ul class="list-disc pl-5 mt-2 space-y-1">
                                <li>Ses inscriptions aux matières</li>
                                <li>Ses paiements</li>
                                <li>Ses absences</li>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <p>
                                Avez-vous envisagé de simplement désactiver le compte étudiant au lieu de le supprimer ?
                                Cela permettra de conserver les données historiques tout en empêchant l'accès au compte.
                            </p>
                            <div class="mt-4">
                                <a href="{{ route('admin.etudiants.edit', $etudiant) }}" class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500">
                    ...
                    <div class="flex items-center">
                        <div class="mr-4">
                            <label for="confirm_delete" class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-700">Je confirme vouloir supprimer définitivement cet étudiant</span>
                            </label>
                        </div>
