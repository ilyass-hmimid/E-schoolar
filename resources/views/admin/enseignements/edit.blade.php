        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Modifier l'enseignement</h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.enseignements.show', $enseignement) }}" class="btn btn-sm btn-info">
                ...
                <!-- /.card-header -->
                <form action="{{ route('admin.enseignements.update', $enseignement) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('matiere_id') is-invalid @enderror" 
                                        ...
                                        @foreach($matieres as $matiere)
                                            <option value="{{ $matiere->id }}" {{ old('matiere_id', $enseignement->matiere_id) == $matiere->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('classe_id') is-invalid @enderror" 
                                        ...
                                        @foreach($classes as $classe)
                                            <option value="{{ $classe->id }}" {{ old('classe_id', $enseignement->classe_id) == $classe->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('professeur_id') is-invalid @enderror" 
                                        ...
                                        @foreach($professeurs as $professeur)
                                            <option value="{{ $professeur->id }}" {{ old('professeur_id', $enseignement->professeur_id) == $professeur->id ? 'selected' : '' }}>
                                                {{ $professeur->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('annee_scolaire') is-invalid @enderror" 
                                           ...
                                           value="{{ old('annee_scolaire', $enseignement->annee_scolaire) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('volume_horaire') is-invalid @enderror" 
                                           ...
                                           value="{{ old('volume_horaire', $enseignement->volume_horaire) }}" min="0" step="0.5" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('coefficient') is-invalid @enderror" 
                                           ...
                                           value="{{ old('coefficient', $enseignement->coefficient) }}" min="1" required>
                                    @error('coefficient')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('semestre') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('semestre', $enseignement->semestre) == '1' ? 'selected' : '' }}>Semestre 1</option>
                                        <option value="2" {{ old('semestre', $enseignement->semestre) == '2' ? 'selected' : '' }}>Semestre 2</option>
                                    </select>
                                    @error('semestre')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3">{{ old('description', $enseignement->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" 
                                       name="is_active" value="1" {{ old('is_active', $enseignement->is_active) ? 'checked' : '' }}>
