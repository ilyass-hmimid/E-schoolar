...
@section('title', 'Créer une nouvelle matière')
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <form action="{{ route('admin.matieres.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <select id="niveau" name="niveau" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                ...
                                <optgroup label="Primaire">
                                    <option value="primaire_3" {{ old('niveau') == 'primaire_3' ? 'selected' : '' }}>3ème année primaire</option>
                                    <option value="primaire_4" {{ old('niveau') == 'primaire_4' ? 'selected' : '' }}>4ème année primaire</option>
                                    <option value="primaire_5" {{ old('niveau') == 'primaire_5' ? 'selected' : '' }}>5ème année primaire</option>
                                    <option value="primaire_6" {{ old('niveau') == 'primaire_6' ? 'selected' : '' }}>6ème année primaire</option>
                                </optgroup>
                                <optgroup label="Collège">
                                    <option value="college_1" {{ old('niveau') == 'college_1' ? 'selected' : '' }}>1ère année collège</option>
                                    <option value="college_2" {{ old('niveau') == 'college_2' ? 'selected' : '' }}>2ème année collège</option>
                                    <option value="college_3" {{ old('niveau') == 'college_3' ? 'selected' : '' }}>3ème année collège</option>
                                </optgroup>
                                <optgroup label="Lycée">
                                    <option value="tronc_commun" {{ old('niveau') == 'tronc_commun' ? 'selected' : '' }}>Tronc commun</option>
                                    <option value="1bac_sm" {{ old('niveau') == '1bac_sm' ? 'selected' : '' }}>1ère année bac - Sciences Maths</option>
                                    <option value="1bac_sv" {{ old('niveau') == '1bac_sv' ? 'selected' : '' }}>1ère année bac - Sciences Physiques</option>
                                    <option value="2bac_sm" {{ old('niveau') == '2bac_sm' ? 'selected' : '' }}>2ème année bac - Sciences Maths</option>
                                    <option value="2bac_sv" {{ old('niveau') == '2bac_sv' ? 'selected' : '' }}>2ème année bac - Sciences Physiques</option>
                                </optgroup>
                            </select>
                            @error('niveau')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="prix_mensuel" id="prix_mensuel" 
                                       value="{{ old('prix_mensuel', 0) }}" step="0.01" min="0"
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="prix_trimestriel" id="prix_trimestriel" 
                                       value="{{ old('prix_trimestriel') }}" step="0.01" min="0"
                                       class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-12 pr-12 sm:text-sm border-gray-300 rounded-md"
                                       placeholder="0.00">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center">
                                <input type="color" name="couleur" id="couleur" value="{{ old('couleur', '#3b82f6') }}"
                                       class="h-10 w-16 p-1 border border-gray-300 rounded-md">
                                <input type="text" id="couleur_hex" value="{{ old('couleur', '#3b82f6') }}"
            ...
            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                <a href="{{ route('admin.matieres.index') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Annuler
                </a>
