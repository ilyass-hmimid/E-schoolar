  ...
  <AppLayout>
    <template #header>
      <div class="flex items-center justify-between">
        ...
        <div class="space-x-2">
          <Link
            :href="route('admin.packs.show', pack.id)"
        ...
        <div class="p-6 overflow-hidden bg-white shadow-sm sm:rounded-lg">
          <form @submit.prevent="submit">
            <div class="space-y-6">
              ...
              <div class="flex items-center justify-between px-6 py-3 space-x-3 text-right bg-gray-50 sm:px-6">
                <button
                  type="button"
...
const form = useForm({
  ...
  prix: props.pack.prix,
  prix_promo: props.pack.prix_promo,
  duree_jours: props.pack.duree_jours,
...
const submit = () => {
  form.put(route('admin.packs.update', props.pack.id), {
    preserveScroll: true,
    onSuccess: () => {
...
const deletePack = () => {
  deleteForm.delete(route('admin.packs.destroy', props.pack.id), {
    preserveScroll: true,
    onSuccess: () => {
