<template>
  <AppLayout :title="`Modifier l'utilisateur - ${user.name}`">
    <template #header>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
          <form @submit.prevent="submit">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <!-- Password (optional) -->
              <div>
                <InputLabel for="password" value="Nouveau mot de passe (laisser vide pour ne pas changer)" />
                <TextInput
                  id="password"
...
const form = useForm({
  ...
  niveau_id: props.user.niveau_id || '',
  filiere_id: props.user.filiere_id || '',
  somme_a_payer: props.user.somme_a_payer || 0,
  date_debut: props.user.date_debut || '',
