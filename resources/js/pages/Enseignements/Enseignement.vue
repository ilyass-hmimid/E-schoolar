...
<!--The form is here => -->
    ...
    <select v-model="selectedMatiere"  @change="handleMatiereChange($event.target.value)" class="form-control" id="mat" required style="color: black !important;">
        <option v-if="!editing" value="">Sélectionner une matière</option>
        <option v-for="matiere in matieres" :key="matiere.id" :value="matiere" style="color: black !important;">{{ matiere }}</option>
    </select>
...
<div v-if="editing" class="form-group">
                ...
                :class="{'is-invalid': errors.SalaireParEtu }"
                 id="SalaireParEtu" placeholder="Entrer un nouveau salaire par étudiant" required />
