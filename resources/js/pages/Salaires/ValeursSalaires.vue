<template>
  ...
  <thead>
    <tr> <br> <th :colspan="TotalMat" style="text-align: center !important;">Matières</th>
</tr>
    <tr>
  ...
  <tbody>
    ...
    <tr v-for="(niveau, niveauIndex) in niveaux" :key="niveau.id">
      ...
      <template v-for="(nbr, nbrIndex) in matieres" :key="nbrIndex">
        ...
        <td v-if="((niveau == '6éme primaire' && nbr != 'Primaire') || (niveau == '5éme primaire' && nbr != 'Primaire')) ">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="userFormModalLabel">
          <span v-if="NivToEdit === '6éme primaire' || NivToEdit === '5éme primaire'">Modifier la valeur de salaire pour {{ NivToEdit }}</span>
